...
public class AccountController {
    ...
    // Endpoint này có thể sử dụng bởi bất kỳ tài khoản đã đăng nhập nào để xem
    // thông tin của mình
    ...
    // Endpoint update (reset password) cho tài khoản; có thể dùng cho USER và ADMIN
    // (cần logic kiểm tra quyền trong service nếu cần)
    @PreAuthorize("isAuthenticated()")
